...
### 順序 1：置中封面圖片（可選，私有模式跳過）

**私有模式：完全跳過此區段。**

**公開模式：若專案根目錄或 `doc/` 下存在 logo 圖片（如 `logo.svg`、`logo.png`），使用置中 HTML 格式：**
```markdown
<p align="center">
<picture>
...
### 順序 2：置中標語 + 置中徽章 + 分隔線（私有模式跳過）

**私有模式：完全跳過此區段（不含標語、不含 `***` 分隔線）**——LLM 生成通知的 `***` 之後直接接順序 3 的一句話描述。
...
<a href="https://www.jsdelivr.com/package/npm/{package}"><img src="https://img.shields.io/jsdelivr/npm/hm/{package}?include_prereleases&style=for-the-badge" alt="Downloads"></a>
<a href="https://www.npmjs.com/package/{package}"><img src="https://img.shields.io/npm/l/{package}?include_prereleases&style=for-the-badge" alt="License"></a>
```

### PHP
```html
<a href="https://packagist.org/packages/{package}"><img src="https://img.shields.io/packagist/v/{package}?include_prereleases&style=for-the-badge" alt="Packagist"></a>
<a href="https://packagist.org/packages/{package}"><img src="https://img.shields.io/packagist/dt/{package}?include_prereleases&style=for-the-badge" alt="Downloads"></a>
<a href="https://packagist.org/packages/{package}"><img src="https://img.shields.io/packagist/l/{package}?include_prereleases&style=for-the-badge" alt="License"></a>
```

**PHP `{package}` 須為 composer.json 的 `name` 欄位格式（`vendor/package`），與其他語言的純套件名不同。**
